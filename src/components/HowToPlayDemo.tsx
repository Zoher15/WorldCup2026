        ...
        <div className="mt-4">
          <div className="rounded-2xl glass p-4 text-center">
            <p className="text-sm font-medium text-stone-200">
              Final score <strong className="text-sky-400">{RESULT.home}–{RESULT.away}</strong>. You
              scored{" "}
              <strong className="text-emerald-400">{you.total} points</strong> —{" "}
          ...
          <ol className="space-y-2">
            {board.map((r, i) => (
              <li
                ...
                className={`rise-in flex items-center gap-3 rounded-2xl px-4 py-2.5 text-stone-100 ${
                  r.you
              ...
              >
                ...
                <span className="w-14 text-right font-black tabular-nums text-emerald-400">
                  {r.score.total} pts
                </span>
              </li>
            ))}
