            ...
            <li key={g.code}>
              ...
              >
                ...
                <span className="min-w-0 flex-1">
                  ...
                  <span className="block truncate text-xs font-medium text-stone-500 dark:text-stone-400">
                    {g.displayName} · {g.rank} of {g.total}
                  </span>
                </span>
                <span className="shrink-0 font-black tabular-nums text-pitch dark:text-emerald-400">
                  {g.live ? "~" : ""}
                  {g.points} pt{g.points === 1 ? "" : "s"}
                </span>
                <span className="shrink-0 text-grape dark:text-violet-300">→</span>
              </Link>
            </li>
          ))}
        </ul>
