  ...
  return (
    <main className="mx-auto max-w-md px-4 py-12">
      ...
      <p className="mb-6 text-sm font-medium text-stone-300">
        Join <strong className="text-violet-300">{groupName}</strong> and
        start predicting.
      </p>
      ...
      <form action={acceptInviteAction} className="space-y-4">
        ...
        <div>
          <label className="mb-1 block text-sm font-bold text-stone-200">
        ...
        <button
          type="submit"
          className="w-full rounded-full glass py-3.5 text-lg font-bold text-emerald-400 transition active:scale-95"
        >
          Join {groupName} →
        </button>
      </form>
